                ...
                <div class="card mt-3">
                    <div class="card-header border-bottom d-flex justify-content-between">
                        ...
                        <div class="d-flex ms-auto">
                            <a href="@route('admin.service.create')" class="btn btn-info-gradient me-3">
                                            ...
                                            <td>{{ $service->name }}</td>
                                             <td>
                                                <label class="custom-switch">
                                                    <input type="checkbox" class="custom-switch-input change-status" data-id="{{ $service->id }}" {{ $service->status == 'active' ? 'checked' : '' }}>
