                ...
                <div class="card mt-3">
                    <div class="card-header border-bottom d-flex justify-content-between">
                        ...
                        <div class="d-flex ms-auto">
                            <a href="@route('admin.pages.create')" class="btn btn-dark me-3">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <label class="custom-switch">
                                                    <input type="checkbox" class="custom-switch-input change-status"
                                                        data-id="{{ $page->id }}"
                                            ...
                                            <td>
                                                ...
                                                <a href="{{ route('admin.pages.edit', $page->id) }}"
                                                    class="btn btn-dark  br-50 m-1" data-bs-toggle="tooltip"
