            ...
            <div class="col-lg-8 mb-lg-30">
                <div class="blog-detail-wrap page-single-2">
                    <div class="inner">
                        ...
                        <div class="image">
                            <img class="lazyload" data-src="{{asset('front/images/blog/blog-details-2.jpg')}}" src="{{asset('front/images/blog/blog-details-2.jpg')}}" alt="">
                        </div>
                        <div class="heading">
                        ...
                        <div class="group-image d-flex gap-20">
                            <div>
                                <img src="{{asset('front/images/blog/blog-details-3.jpg')}}" alt="">
                            </div>
                            <div>
                                <img src="{{asset('front/images/blog/blog-details-4.jpg')}}" alt="">
                            </div>
                        </div>
                        <div class="content">
            ...
            <div class="col-lg-4">
                <div class="sidebar maxw-360">
                    ...
                    <div class="sidebar-item sidebar-relatest-post">
                        <h5 class="sidebar-heading related-post fw-bold">Latest Post</h5>

                        <div>
                            <div class="relatest-post-item style-row hover-image">
                                <div class="image">
                                    <img class="lazyload" data-src="{{asset('front/images/blog/sidebar-2.jpg')}}" src="{{asset('front/images/blog/sidebar-2.jpg')}}" alt="">
                                </div>
                                <div class="content">
                                    <div class="meta">
                                        <div class="meta-item gap-8">
                            ...
                            <div class="relatest-post-item style-row hover-image">
                                <div class="image">
                                    <img class="lazyload" data-src="{{asset('front/images/blog/sidebar-3.jpg')}}" src="{{asset('front/images/blog/sidebar-3.jpg')}}" alt="">
                                </div>
                                <div class="content">
                                    <div class="meta">
                                        <div class="meta-item gap-8">
