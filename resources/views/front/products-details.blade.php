                            ...
                            <div class="">
                                ...
                                <div class="tf-product-info-desc">
                                    ...
                                    <div class="tf-product-info-price">
                                        <h5 class="price-on-sale font-2">Product Details</h5>
                                    </div>
                                    <ul class="tf-product-info-sku">
                                        <li><strong>SKU:</strong> 53453412</li>
                                        <li><strong>Vendor:</strong> Modave</li>
                                        <li><strong>Available:</strong> Instock</li>
                                        <li><strong>Categories:</strong>
                                            <a href="#" class="text-1 link">Clothes</a>,
                                            <a href="#" class="text-1 link">Women</a>,
                                            <a href="#" class="text-1 link">T-shirt</a>
                                        </li>
                                    </ul>
                                </div>
                            </div>
