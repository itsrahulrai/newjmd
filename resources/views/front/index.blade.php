...
<body class="preload-wrapper">
    ...
    <div id="wrapper">
            ...
            <div class="carousel-inner">
                ...
                <img src="images/banner/banner-1.webp" class="d-block w-100" alt="...">
                </div>
                <div class="carousel-item">
                <img src="images/banner/banner-1.webp" class="d-block w-100" alt="...">
                </div>
                <div class="carousel-item">
                <img src="images/banner/banner-1.webps" class="d-block w-100" alt="...">
                </div>
            </div>
                            ...
                            <div class="swiper-wrapper">
                                <div class="swiper-slide">
                                    <div class="collection-position-2 style-8 hover-img">
                                        <a class="img-style">
                                            <img class="lazyload" data-src="images/cat/mcb.png" src="images/cat/mcb.png" alt="electronic-cls">
                                        </a>
                                        <div class="top">
                                ...
                                <div class="swiper-slide">
                                    <div class="collection-position-2 style-8 hover-img">
                                        <a class="img-style">
                                            <img class="lazyload" data-src="images/cat/change-overs.png" src="images/cat/change-overs.png" alt="electronic-cls">
                                        </a>
                                        <div class="top">
                                ...
                                <div class="swiper-slide">
                                    <div class="collection-position-2 style-8 hover-img">
                                        <a class="img-style">
                                            <img class="lazyload" data-src="images/cat/door-bell.png" src="images/cat/door-bell.png" alt="electronic-cls">
                                        </a>
                                        <div class="top">
                                ...
                                <div class="swiper-slide">
                                    <div class="collection-position-2 style-8 hover-img">
                                        <a class="img-style">
                                            <img class="lazyload" data-src="images/cat/distribution-boxes.png" src="images/cat/distribution-boxes.png" alt="electronic-cls">
                                        </a>
                                        <div class="top">
                        ...
                        <div class="swiper-wrapper">
                            ...
                            <div class="swiper-slide">
                                <div class="collection-default abs-left-center rounded-0 hover-img wow fadeInUp" data-wow-delay="0s">
                                    <a class="img-style">
                                        <img class="lazyload" data-src="images/collections/cls-sock-1.jpg" src="images/collections/cls-sock-1.jpg" alt="banner-cls">
                                    </a>
                            ...
                            <div class="swiper-slide">
                                <div class="collection-default abs-left-center rounded-0 hover-img wow fadeInUp" data-wow-delay="0s">
                                    <a class="img-style">
                                        <img class="lazyload" data-src="images/collections/cls-sock-2.jpg" src="images/collections/cls-sock-2.jpg" alt="banner-cls">
                                    </a>
                                    <div class="content text-start">
                                        <div class="box-title">
                                            <h4 class="title">
                            ...
                            <div class="swiper-slide">
                                <div class="collection-default abs-left-center rounded-0 hover-img wow fadeInUp" data-wow-delay="0s">
                                    <a class="img-style">
                                        <img class="lazyload" data-src="images/collections/cls-sock-3.jpg" src="images/collections/cls-sock-3.jpg" alt="banner-cls">
                                    </a>
                                    <div class="content text-start">
                                        <div class="box-title">
                                            <h4 class="title">
